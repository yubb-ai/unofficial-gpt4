...
public class TaskSchedulingConfigurations__BeanDefinitions {
  ...
  public static class TaskSchedulerConfiguration {
    ...
    private static BeanInstanceSupplier<ThreadPoolTaskScheduler> getTaskSchedulerInstanceSupplier(
      ...
      return BeanInstanceSupplier.<ThreadPoolTaskScheduler>forFactoryMethod(TaskSchedulingConfigurations.TaskSchedulerConfiguration.class, "taskScheduler", TaskSchedulerBuilder.class, ObjectProvider.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(TaskSchedulingConfigurations.TaskSchedulerConfiguration.class).taskScheduler(args.get(0), args.get(1)));
    }
